 ...
 */
public class SortBlockletIterator extends BlockletIterator {
   ...
   */
  public SortBlockletIterator(List<DataRefNode> datablocks, SortOrderType sortType) {
    super(SortOrderType.ASC.equals(sortType) ? datablocks.get(0) : datablocks.get(datablocks.size()-1), datablocks.size());
