 ...
 * complete data
 */
public class NonFilterQueryScannedSortResult extends AbstractScannedSortResult {

  public NonFilterQueryScannedSortResult(BlockExecutionInfo blockExecutionInfo) {
