...
import org.apache.carbondata.core.scan.result.impl.FilterQueryScannedReverseMdkResult;
 ...
 */
public class FilterSortByMdkScanner extends FilterScanner {

  private SortOrderType sortType = SortOrderType.ASC;

  public FilterSortByMdkScanner(BlockExecutionInfo blockExecutionInfo,
  ...
  protected AbstractScannedResult getScannedResult() {
    if (SortOrderType.ASC.equals(sortType)) {
      return new FilterQueryScannedResult(blockExecutionInfo);
    }
    return new FilterQueryScannedReverseMdkResult(blockExecutionInfo);
  }
}
