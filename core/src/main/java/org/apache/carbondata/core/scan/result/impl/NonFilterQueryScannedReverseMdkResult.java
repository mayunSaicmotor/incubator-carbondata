 ...
 * complete data
 */
public class NonFilterQueryScannedReverseMdkResult extends NonFilterQueryScannedResult {

  public NonFilterQueryScannedReverseMdkResult(BlockExecutionInfo blockExecutionInfo) {
