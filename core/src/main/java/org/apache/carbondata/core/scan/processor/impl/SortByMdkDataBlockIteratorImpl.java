...
import org.apache.carbondata.core.scan.processor.SortBlockletIterator;
import org.apache.carbondata.core.scan.scanner.impl.FilterSortByMdkScanner;
import org.apache.carbondata.core.scan.scanner.impl.NonFilterSortByMdkScanner;
import org.apache.carbondata.core.stats.QueryStatisticsModel;

/**
 * Below class will be used to process the block for detail query
 */
public class SortByMdkDataBlockIteratorImpl extends DataBlockIteratorImpl {
   ...
   */
  public SortByMdkDataBlockIteratorImpl(BlockExecutionInfo blockExecutionInfo,
  ...
  protected void getBlockletScanner(BlockExecutionInfo blockExecutionInfo,
    ...
    if (blockExecutionInfo.getFilterExecuterTree() != null) {
      blockletScanner = new FilterSortByMdkScanner(blockExecutionInfo, queryStatisticsModel,
          sortType);
    } else {
      blockletScanner = new NonFilterSortByMdkScanner(blockExecutionInfo, queryStatisticsModel,
          sortType);
    }
  }
  ...
  protected void getBlockIterator(BlockExecutionInfo blockExecutionInfo) {
    ...
    dataBlockIterator = new SortBlockletIterator(dataList, sortType);
  }
