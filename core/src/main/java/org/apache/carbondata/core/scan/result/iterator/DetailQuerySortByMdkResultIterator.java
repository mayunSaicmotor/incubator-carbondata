...
import org.apache.carbondata.core.scan.processor.impl.SortByMdkDataBlockIteratorImpl;
 ...
 */
public class DetailQuerySortByMdkResultIterator extends AbstractDetailQueryResultIterator<BatchResult> {

  private final Object lock = new Object();
  private SortOrderType sortType = SortOrderType.ASC;

  public DetailQuerySortByMdkResultIterator(List<BlockExecutionInfo> infos, QueryModel queryModel,
    ...
    // sort by MDK key only consider these sort dimensions have the same order type
  ...
  protected DataBlockIteratorImpl getDataBlockIterator(BlockExecutionInfo executionInfo) {
    return new SortByMdkDataBlockIteratorImpl(executionInfo, fileReader, batchSize, queryStatisticsModel,
        execService, sortType);
  }
