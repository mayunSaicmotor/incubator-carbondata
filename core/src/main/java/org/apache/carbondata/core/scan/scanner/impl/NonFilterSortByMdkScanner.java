...
import org.apache.carbondata.core.scan.result.impl.NonFilterQueryScannedReverseMdkResult;
 ...
 */
public class NonFilterSortByMdkScanner extends NonFilterScanner {
  private SortOrderType sortType = SortOrderType.ASC;
  public NonFilterSortByMdkScanner(BlockExecutionInfo blockExecutionInfo,
  ...
  protected AbstractScannedResult getScannedResult() {
    if(SortOrderType.ASC.equals(sortType)){
     ...
     return new NonFilterQueryScannedReverseMdkResult(blockExecutionInfo);
  }
}
